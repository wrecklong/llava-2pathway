...
class LlavaQwen2pathwayfixexpertConfig(Qwen3Config):
    model_type = "llava_qwen_2pathway"


class LlavaQwen2pathwayfixexpertModel(LlavaMetaModel, Qwen3Model):
    config_class = LlavaQwen2pathwayfixexpertConfig

    def __init__(self, config: Qwen3Config):
        super(LlavaQwen2pathwayfixexpertModel, self).__init__(config)
...
class LlavaQwen2pathwayfixexpertForCausalLM(Qwen3ForCausalLM, LlavaMetaForCausalLM):
    config_class = LlavaQwen2pathwayfixexpertConfig
    ...
    def __init__(self, config):
        ...
        self.model = LlavaQwen2pathwayfixexpertModel(config)
    ...
    def forward(
        ...
        if labels is not None:
            ...
            loss = loss  + token_routing_ratio_loss
...
AutoConfig.register("llava_qwen_2pathway", LlavaQwen2pathwayfixexpertConfig)
AutoModelForCausalLM.register(LlavaQwen2pathwayfixexpertConfig, LlavaQwen2pathwayfixexpertForCausalLM)